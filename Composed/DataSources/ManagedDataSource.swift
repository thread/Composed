...
open class ManagedDataSource<Element>: NSObject, NSFetchedResultsControllerDelegate, CollectionDataSource
    where Element: NSManagedObject {

    public typealias Store = ArrayStore<Element>
    ...
    open func invalidate() {
        guard isActive, let request = request else { return }
        request.returnsObjectsAsFaults = false
