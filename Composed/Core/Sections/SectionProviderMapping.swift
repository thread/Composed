// Do we really need to import UIKit here in order to access the collection views IndexPath(item:section:)?
import Foundation
...
/**
 ...
 t encapsulates the logic required to map `SectionProvider`s to
